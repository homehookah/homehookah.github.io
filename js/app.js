...
},{"./inputmask.dependencyLib.jquery":1}],3:[function(require,module,exports){
/*!
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var phoneMask = new _inputmask2.default("+7(999)999-99-99");
  ...
  var $form = (0, _jquery2.default)('[data-form]');
  ...
  $form.on('submit', function (event) {
    ...
    _jquery2.default.each(formData, function (index, field) {
      if (!field.value) {
        return false;
      }
    ...
    _jquery2.default.ajax({
      type: "POST",
      url: "https://api.telegram.org/bot" + "305381096:AAFoHToZFxHaASaS4jXMv7XITYNHpIBgssM" + "/sendMessage",
...
},{"jquery":3,"jquery.inputmask/dist/inputmask/inputmask.js":2,"remodal":4}]},{},[5]);
